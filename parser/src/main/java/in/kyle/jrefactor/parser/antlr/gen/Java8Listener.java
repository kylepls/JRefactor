...
public interface Java8Listener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code lambdaIdentifierParameter}
	 * labeled alternative in {@link Java8Parser#lambdaParameters}.
	 * @param ctx the parse tree
	 */
	void enterLambdaIdentifierParameter(Java8Parser.LambdaIdentifierParameterContext ctx);
	/**
	 * Exit a parse tree produced by the {@code lambdaIdentifierParameter}
	 * labeled alternative in {@link Java8Parser#lambdaParameters}.
	 * @param ctx the parse tree
	 */
	void exitLambdaIdentifierParameter(Java8Parser.LambdaIdentifierParameterContext ctx);
	/**
	 * Enter a parse tree produced by the {@code lambdaParameterList}
	 * labeled alternative in {@link Java8Parser#lambdaParameters}.
	 * @param ctx the parse tree
	 */
	void enterLambdaParameterList(Java8Parser.LambdaParameterListContext ctx);
	/**
	 * Exit a parse tree produced by the {@code lambdaParameterList}
	 * labeled alternative in {@link Java8Parser#lambdaParameters}.
	 * @param ctx the parse tree
	 */
	void exitLambdaParameterList(Java8Parser.LambdaParameterListContext ctx);
	/**
	 * Enter a parse tree produced by the {@code lambdaInferedParameterList}
	 * labeled alternative in {@link Java8Parser#lambdaParameters}.
	 * @param ctx the parse tree
	 */
	void enterLambdaInferedParameterList(Java8Parser.LambdaInferedParameterListContext ctx);
	/**
	 * Exit a parse tree produced by the {@code lambdaInferedParameterList}
	 * labeled alternative in {@link Java8Parser#lambdaParameters}.
	 * @param ctx the parse tree
	 */
	void exitLambdaInferedParameterList(Java8Parser.LambdaInferedParameterListContext ctx);
	/**
