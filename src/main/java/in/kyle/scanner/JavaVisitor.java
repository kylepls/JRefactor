...
public interface JavaVisitor<T> {
    T visitJObjectList(in.kyle.JObjectList object);
    ...
    T visitJExpressionName(in.kyle.parser.expression.JExpressionName object);
    T visitJLamdaExpression(in.kyle.parser.expression.JLamdaExpression object);
    T visitJIdentifierParameter(in.kyle.parser.expression.JLamdaParameters.JIdentifierParameter object);
    T visitJLamdaParameters(in.kyle.parser.expression.JLamdaParameters object);
    ...
    T visitJTernaryExpression(in.kyle.parser.expression.JTernaryExpression object);
    ...
    T visitJCharacterLiteral(in.kyle.parser.expression.literal.JCharacterLiteral object);
    T visitJDoubleLiteral(in.kyle.parser.expression.literal.JDoubleLiteral object);
    T visitJFloatingLiteral(in.kyle.parser.expression.literal.JFloatingLiteral object);
    ...
    T visitJMemberList(in.kyle.parser.unit.body.JMemberList object);
    ...
    T visitJTypeDeclaration(in.kyle.parser.unit.JTypeDeclaration object);
    T visitJTypeName(in.kyle.parser.unit.JTypeName object);
    T visitJTypeParameter(in.kyle.parser.unit.JTypeParameter object);
    T visitJTypeParameterList(in.kyle.parser.unit.JTypeParameterList object);
    T visitModifiable(in.kyle.parser.unit.Modifiable object);
    T visitModifierList(in.kyle.parser.unit.ModifierList object);
