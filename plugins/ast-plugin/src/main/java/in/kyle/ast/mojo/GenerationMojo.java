...
import in.kyle.ast.code.processors.PackageNamePreprocessor;
import in.kyle.ast.code.processors.TypeNameProcessor;
...
public class GenerationMojo extends AbstractMojo {
    ...
    private void generateSourcesForFile(File file) throws IOException {
        ...
        modifier.getProcessor(PackageNamePreprocessor.class).setPackagePrefix(packageName);
        modifier.getProcessor(TypeNameProcessor.class).setFilePrefix(filePrefix);
