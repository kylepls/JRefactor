...
public interface JavaListener {
    ...
    void enterAnnotationBase(JAnnotationList object);
    void exitAnnotationBase(JAnnotationList object);
    void enterJAnnotationBody(in.kyle.jrefactor.parser.unit.types.annotationtype.JAnnotationBody object);
    void exitJAnnotationBody(in.kyle.jrefactor.parser.unit.types.annotationtype.JAnnotationBody object);
    void enterJAnnotationMember(in.kyle.jrefactor.parser.unit.types.annotationtype.JAnnotationMember object);
    void exitJAnnotationMember(in.kyle.jrefactor.parser.unit.types.annotationtype.JAnnotationMember object);
    void enterJAnnotationTypeElement(in.kyle.jrefactor.parser.unit.types.annotationtype.JAnnotationTypeElement object);
    void exitJAnnotationTypeElement(in.kyle.jrefactor.parser.unit.types.annotationtype.JAnnotationTypeElement object);
    void enterJElementValue(in.kyle.jrefactor.parser.unit.types.annotationtype.JElementValue object);
    void exitJElementValue(in.kyle.jrefactor.parser.unit.types.annotationtype.JElementValue object);
    void enterJClassBody(in.kyle.jrefactor.parser.unit.types.classtype.JClassBody object);
    void exitJClassBody(in.kyle.jrefactor.parser.unit.types.classtype.JClassBody object);
    void enterJClassInitializer(in.kyle.jrefactor.parser.unit.types.classtype.JClassInitializer object);
    void exitJClassInitializer(in.kyle.jrefactor.parser.unit.types.classtype.JClassInitializer object);
    void enterJClassInstanceInitializer(in.kyle.jrefactor.parser.unit.types.classtype.JClassInstanceInitializer object);
    void exitJClassInstanceInitializer(in.kyle.jrefactor.parser.unit.types.classtype.JClassInstanceInitializer object);
    void enterJClassMember(in.kyle.jrefactor.parser.unit.types.classtype.JClassMember object);
    void exitJClassMember(in.kyle.jrefactor.parser.unit.types.classtype.JClassMember object);
    void enterJClassStaticInitializer(in.kyle.jrefactor.parser.unit.types.classtype.JClassStaticInitializer object);
    void exitJClassStaticInitializer(in.kyle.jrefactor.parser.unit.types.classtype.JClassStaticInitializer object);
    void enterJField(in.kyle.jrefactor.parser.unit.types.classtype.JField object);
    void exitJField(in.kyle.jrefactor.parser.unit.types.classtype.JField object);
    void enterJEnumBody(in.kyle.jrefactor.parser.unit.types.enumtype.JEnumBody object);
    void exitJEnumBody(in.kyle.jrefactor.parser.unit.types.enumtype.JEnumBody object);
    void enterJEnumConstant(in.kyle.jrefactor.parser.unit.types.enumtype.JEnumConstant object);
    void exitJEnumConstant(in.kyle.jrefactor.parser.unit.types.enumtype.JEnumConstant object);
    void enterJEnumMember(in.kyle.jrefactor.parser.unit.types.enumtype.JEnumMember object);
    void exitJEnumMember(in.kyle.jrefactor.parser.unit.types.enumtype.JEnumMember object);
    void enterJInterfaceBody(in.kyle.jrefactor.parser.unit.types.interfacetype.JInterfaceBody object);
    void exitJInterfaceBody(in.kyle.jrefactor.parser.unit.types.interfacetype.JInterfaceBody object);
    void enterJInterfaceMember(in.kyle.jrefactor.parser.unit.types.interfacetype.JInterfaceMember object);
    void exitJInterfaceMember(in.kyle.jrefactor.parser.unit.types.interfacetype.JInterfaceMember object);
    void enterJInterfaceMethod(in.kyle.jrefactor.parser.unit.types.interfacetype.JInterfaceMethod object);
    void exitJInterfaceMethod(in.kyle.jrefactor.parser.unit.types.interfacetype.JInterfaceMethod object);
    ...
    void enterJAnnotatable(JAnnotatable object);
    void exitJAnnotatable(JAnnotatable object);
    void enterJAnnotation(JAnnotation object);
    void exitJAnnotation(JAnnotation object);
    void enterJElementPair(JAnnotationValue.JElementPair object);
    void exitJElementPair(JAnnotationValue.JElementPair object);
    void enterJPairCollection(JAnnotationValue.JPairCollection object);
    void exitJPairCollection(JAnnotationValue.JPairCollection object);
    void enterJSingleValue(JAnnotationValue.JSingleValue object);
    void exitJSingleValue(JAnnotationValue.JSingleValue object);
    void enterJAnnotationValue(JAnnotationValue object);
    void exitJAnnotationValue(JAnnotationValue object);
    ...
    void enterModifiable(Modifiable object);
    void exitModifiable(Modifiable object);
    void enterModifierList(JModifierList object);
    void exitModifierList(JModifierList object);
